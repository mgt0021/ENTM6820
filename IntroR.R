...
x + seven #this returns an error becasue seven is a character var
...
csv <- read.csv("C:/Users/mgt19/Downloads/TestData2024 (1).csv", na.strings = "na") # insert full file path here, can tell R what missing values are called in your csv, ex: na
getwd()
